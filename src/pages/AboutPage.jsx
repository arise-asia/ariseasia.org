...
const AboutPage = () => (
  <>
    <div className="px-4 pt-60 pb-10 bg-red-50">
      <div className="container">
        <h1 className="mb-20 text-4xl font-bold text-center text-red-700 uppercase sm:text-5xl md:text-7xl font-heading">
          About Us
        </h1>

        <AboutArise />

        <h2 className="my-6 text-2xl font-bold text-center text-red-700 uppercase md:text-4xl font-heading">
          About Arise Asia
        </h2>
        <div className="mx-auto mt-8 font-bold text-center text-black prose">
          <p>
